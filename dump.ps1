...
$i = 0
while($true) {
    adb -s $DeviceName shell am broadcast -a test.DUMP_COVERAGE
    ...
    adb -s $DeviceName pull /data/user/0/$PackageName/files/coverage/coverage.ec $OutputDir/coverage.$i.$eventCount.ec
